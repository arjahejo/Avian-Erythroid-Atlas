##Structural and Temporal Constraints in Avian Erythrocytes
...
##Project Overview
This repository contains the complete analytical pipeline for the study: "Structural and Temporal Constraints in Avian Erythrocytes" (Jahejo et al., 2025).
Birds retain a functional nucleus in their mature erythrocytes, whereas mammals do not. This study identifies the molecular barriers to enucleation in the avian lineage, specifically highlighting the role of Vimentin persistence and the uncoupling of the TGFB1–SRF–RHOA signaling axis.
...
Jahejo et al. (2025). Structural and Temporal Constraints in Avian Erythrocytes (In Review).
