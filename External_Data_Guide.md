...
*   **Placement:** The re-annotated file is provided at `./External_Data_File/Richard2016_Bulk_T2EC.csv`.
...
*   **Placement:** Processed gene-level counts are provided at `./External_Data_File/Immature_Ery.csv` and `./External_Data_File/Mature_Ery.csv`.
...
## 6. Human iPSC-Derived Erythroblasts (Primitive vs. Definitive vs. Fetal Liver)
*   **Source:** Pavani et al. (2024), *Blood Advances* (DOI: https://doi.org/10.1182/bloodadvances.2023011708).
*   **Rationale:** Provides an in vitro human erythropoiesis model capturing primitive, definitive, and fetal liver-derived erythroblasts to benchmark enucleation-deficient states against physiological human marrow enucleation and avian nuclear retention.
*   **Data Acquisition:** Download the processed Seurat object `GSE242101_GEOsubm_RBC_dataset.rds.gz` from [NCBI GEO GSE242101](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE242101).
*   **Placement:** Decompress and place in `./Raw_Data/Public_Reference_Data/Pavani_2024/GSE242101.rds`.
